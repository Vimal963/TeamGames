        ...
        private IEnumerator DownloadAssetBundle()
        {
            ...
            switch (request.State)
            {
                ...
                case HTTPRequestStates.Finished:
                    ...
                    {
                        this._statusText.text =
                            $"Request finished Successfully, but the server sent an error. Status Code: {request.Response.StatusCode}-{request.Response.Message} Message: {request.Response.DataAsText}";
