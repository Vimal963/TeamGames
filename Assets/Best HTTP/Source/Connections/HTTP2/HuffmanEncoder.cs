...
namespace BestHTTP.Connections.HTTP2
{
    internal static class HuffmanEncoder
    {
        ...
        public struct TableEntry
        {
            ...
            {
                return $"[TableEntry Code: 0x{this.Code:X}, Bits: {this.Bits}]";
            }
        }
        ...
        public struct TreeNode
        {
            ...
            {
                return
                    $"[TreeNode Value: {this.Value}, NextZeroIdx: {this.NextZeroIdx}, NextOneIdx: {this.NextOneIdx}]";
            }
        }

        private static TableEntry[] StaticTable = new TableEntry[257]
        {
        ...
        private static TreeNode[] HuffmanTree = new TreeNode[]
        {
