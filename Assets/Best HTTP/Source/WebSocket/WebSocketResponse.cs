        ...
        void IHeartbeat.OnHeartbeatUpdate(TimeSpan dif)
        {
            ...
            if (now - (lastMessage + this.PingFrequnecy) > this.WebSocket.CloseAfterNoMesssage)
            {
                HTTPManager.Logger.Warning("WebSocketResponse",
                    $"No message received in the given time! Closing WebSocket. LastMessage: {this.lastMessage}, PingFrequency: {this.PingFrequnecy}, Close After: {this.WebSocket.CloseAfterNoMesssage}, Now: {now}");
