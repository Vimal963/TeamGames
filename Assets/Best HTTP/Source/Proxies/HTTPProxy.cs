                        ...
                        switch (request.ProxyResponse.StatusCode)
                        {
                            ...
                            case 407:
                                {
                                    ...
                                    if (!retry)
                                        throw new Exception(
                                            $"Can't authenticate Proxy! Status Code: \"{request.ProxyResponse.StatusCode}\", Message: \"{request.ProxyResponse.Message}\" and Response: {request.ProxyResponse.DataAsText}");
                                    break;
                                }
                            ...
                            default:
                                if (!request.ProxyResponse.IsSuccess)
                                    throw new Exception(
                                        $"Proxy returned Status Code: \"{request.ProxyResponse.StatusCode}\", Message: \"{request.ProxyResponse.Message}\" and Response: {request.ProxyResponse.DataAsText}");
                                break;
                        }
